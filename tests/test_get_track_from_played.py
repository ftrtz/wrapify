import pandas as pd
import json
from src.etl.utils import get_track_from_played
    ...
    mock_played = pd.DataFrame(
        {
            ...
            "played_at": [
                "2021-09-20T12:34:56.789Z",
                "2021-09-21T14:20:30.123Z",
                "2021-09-22T16:30:45.456Z",
            ],  # Added played_at
            ...
            "album_images": [
                json.dumps(
                    [{"url": "image_1_url"}, {"url": "image_2_url"}, {"url": "image_3_url"}]
                ),
