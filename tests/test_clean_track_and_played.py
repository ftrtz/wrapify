import pandas as pd
from src.etl.utils import clean_track_and_played
...
def test_clean_track_and_played():
    ...
    pd.testing.assert_frame_equal(
        cleaned_track_df.reset_index(drop=True), expected_track_df.reset_index(drop=True)
    )
    pd.testing.assert_frame_equal(
        cleaned_played_df.reset_index(drop=True), expected_played_df.reset_index(drop=True)
    )
