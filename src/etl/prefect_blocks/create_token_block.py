...
def create_token_block(
    token_block_name: str = "spotify-access-token", spotipy_block_name: str = "spotipy"
):
    """
    ...
    if sp.auth_manager.cache_handler.token_info:
        Secret(value=sp.auth_manager.cache_handler.token_info).save(
            token_block_name, overwrite=True
        )
